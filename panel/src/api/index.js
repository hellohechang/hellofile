...
export const getisregisterReq = (params) => req.get('/user/isregister', { params })
...
// 获取用户列表
export const userlistReq = (params) => req.get('/user/root/userlist', { params })

// 搜索操作日志
export const logsearchReq = (params) => req.get('/user/root/logsearch', { params })

// 清空日志
export const logclearReq = (data) => req.post('/user/root/logclear', data)
...
//断点续传
export const breakpointReq = (params) => req.get('/file/breakpoint', { params })
...
// 获取分享
export const getShareInfoReq = (params) => req.get('/file/getshare', { params })
